...
class SokobanPullToNonGoal(IPlannerAction):
    #(PULL-TO-NONGOAL PLAYER-01 STONE-02 POS-08-05 POS-08-06 POS-08-07 DIR-DOWN) [1]
...
class SokobanPullToGoal(IPlannerAction):
    #(PULL-TO-GOAL PLAYER-01 STONE-02 POS-08-03 POS-08-04 POS-08-05 DIR-DOWN) [1]
    # (:action pull-to-goal
   #:parameters (?p - player ?s - stone ?ppos ?from ?to - location ?dir - direction)
