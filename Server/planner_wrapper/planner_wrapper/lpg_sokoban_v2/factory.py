...
class LPG_V2_Factory(IPlannerFactory):

    @property
    def domain_filename(self) -> str:
        return os.path.abspath("../Problems/Sokoban/domainPull.pddl")
    ...
    def planner(self) -> IPlanner:
        if config.USE_PLANNER == "lpg":
            ...
            raise ValueError("'{}' is invalid!".format(config.USE_PLANNER))
    ...
    def plan_to_json(self) -> IPlanToJsonConverter:
        return LPG_V2_PlanToJsonConverter()
